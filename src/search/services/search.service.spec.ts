...
describe('SearchService', () => {
    ...
    it('should call http.get and return mapped trips', async () => {
        ...
        const mockResponse = [
            { origin: 'NYC', destination: 'LAX', duration: 300, cost: 100 },
            { origin: 'NYC', destination: 'LAX', duration: 400, cost: 80 },
        ];

        const mappedResponse = [
            { id: '18c80f09-2e29-499a-aba1-98c20a856244', display_name: 'Trip 1', origin: 'NYC', destination: 'LAX', duration: 300, type: 'car', cost: 100 },
            { id: 'd96f711a-8aae-44fe-9c04-5d10ed36c052', display_name: 'Trip 2', origin: 'NYC', destination: 'LAX', duration: 400, type: 'flight', cost: 80 },
        ];
